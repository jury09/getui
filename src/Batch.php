...
use Exception;
use getui\Core\Request\SingleBatch\Item;
use getui\Core\Request\SingleBatch\Request;
...
class Batch
{
    ...
    public function submit()
    {
        ...
        $data["serialize"] = "pb";
        $data["async"] = Config::isPushSingleBatchAsync();
        $data["action"] = "pushMessageToSingleBatchAction";
        $data['requestId'] = $requestId;
        $singleBatchRequest = new Request();
